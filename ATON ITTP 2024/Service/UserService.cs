...
namespace ATON_ITTP_2024.Service
{
    ...
    {
        private readonly ITTP_2024_Context _dataContext;
        private readonly IWebHostEnvironment _webHostEnvironment;

        public UserService(ITTP_2024_Context dataContext, IWebHostEnvironment webHostEnvironment)
        {
            _dataContext = dataContext;
            _webHostEnvironment = webHostEnvironment;
        }

        public async Task<User> CreateAsync(string login, string password, string name, int gender, DateTime? birthday, bool isAdmin)
        {
